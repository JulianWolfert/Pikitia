...
public class DBInitialization implements InitializingBean{
	...
	public DBInitialization(){
		...
		*/
		...
		initialMessages.add(new Message(users.get(3), "s0528397@htw-berlin.de", 1, "Titel_01", "Text_01"));
		initialMessages.add(new Message(users.get(3), "s0528397@htw-berlin.de", 1, "Titel_02", "Text_02"));
		initialMessages.add(new Message(users.get(2), "s0528397@htw-berlin.de", 1, "Titel_03", "Text_03"));
		initialMessages.add(new Message(users.get(2), "s0528397@htw-berlin.de", 1, "Titel_04", "Text_04"));
